      ...
      >
            ...
            {inactiveBasemaps.map(({ key, label, thumbnail }) => (
              <button
                ...
                className="
                  ...
                  hover:bg-[rgba(247,200,0,0.15)]
                  hover:border-[#f7c800]
                  hover:shadow-[0_4px_14px_rgba(247,200,0,0.4),0_0_18px_rgba(247,200,0,0.2)]
                  focus:outline-2 focus:outline-[#f7c800] focus:outline-offset-2
              ...
              >
                ...
                <div
                  ...
                  tracking-wide
                  group-hover:text-[#f7c800]
                  group-hover:font-bold
                  group-hover:[text-shadow:0_0_6px_rgba(247,200,0,0.5)]
                  contrast-more:text-white
                  contrast-more:[text-shadow:0_2px_4px_rgba(0,0,0,0.8)]
                  max-[768px]:text-[9px] max-[768px]:py-[5px] max-[768px]:px-[3px]
                  max-[480px]:text-[8px] max-[480px]:py-1 max-[480px]:px-0.5
                "
                >
                  {label}
                </div>
        ...
        <button
          className="
            ...
            hover:-translate-y-0.5 hover:scale-[1.02]
            hover:border-[#f7c800]
            hover:bg-[rgba(247,200,0,0.2)]
            hover:shadow-[0_0_0_2px_rgba(247,200,0,0.5),0_5px_18px_rgba(247,200,0,0.4),0_0_25px_rgba(247,200,0,0.2)]
            focus:outline-2 focus:outline-[#f7c800] focus:outline-offset-2
            focus:not(:focus-visible):outline-none
            motion-reduce:transition-none motion-reduce:hover:transform-none
            contrast-more:border-[3px] contrast-more:hover:border-[#f7c800]
            max-[768px]:w-[75px]
            max-[480px]:w-[65px]
          "
        ...
        >
          <div className="w-full h-[70px] relative overflow-hidden bg-black/30 rounded-t-lg max-[768px]:h-[58px] max-[480px]:h-[50px]">
            ...
            <div
              ...
              group-hover:bg-[#f7c800]
              group-hover:shadow-[0_0_10px_rgba(247,200,0,0.6)]
              motion-reduce:transition-none
              max-[768px]:w-[18px] max-[768px]:h-[18px]
            ...
            >
              <svg
                ...
                className={`
                  ...
                  group-hover:[filter:drop-shadow(0_0_3px_rgba(0,0,0,0.5))]
                  motion-reduce:transition-none
                  max-[768px]:w-3.5 max-[768px]:h-3.5
                  max-[480px]:w-3 max-[480px]:h-3
